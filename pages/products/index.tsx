...
const products = [
  {
    ...
    description:
      "High-grown blended coffee made with carefully selected coffee beans for a rich and naturally aromatic cup.",
    badge: "Bestseller",
    isNew: false,
    isOrganic: true,
  },
  ...
  {
    id: 2,
    name: "Moringa Flavoured Foxtail Millet Pasta",
    ...
    description:
      "Nutritious foxtail millet pasta infused with moringa, offering a healthy and delicious ready-to-cook meal.",
  ...
  {
    id: 3,
    name: "Multi Millet Tomato Rice Mix",
    category: "Ready to Cook",
    price: 179,
    rating: 4.8,
    reviews: 92,
    image: "/images/products/Tomato rice mix.webp",
    description:
      "A wholesome multi-millet tomato rice mix made with natural ingredients for a quick, nutritious and flavorful meal.",
    badge: "Popular",
    isNew: false,
    isOrganic: true,
  },
  ...
  {
    id: 4,
    name: "Multi Millet Ven Pongal Mix",
    category: "Ready to Cook",
    price: 179,
    rating: 4.9,
    reviews: 108,
    image: "/images/products/Ven Pongal mix.webp",
    description:
      "Traditional South Indian ven pongal made convenient with a nutritious blend of multiple millets and natural ingredients.",
    badge: "Top Rated",
    isNew: false,
    isOrganic: true,
  },

  {
    ...
    rating: 4.9,
    reviews: 134,
    image: "/images/products/Ashwagandha-Capsules.webp",
    description:
      "Herbal ashwagandha capsules made with natural ingredients for everyday wellness and vitality support.",
    badge: "Bestseller",
    isNew: false,
    isOrganic: true,
  },

  {
    ...
    rating: 4.8,
    reviews: 97,
    image: "/images/products/Neem-Turmeric-Face-Wash.webp",
    description:
      "A refreshing herbal face wash enriched with neem extract and turmeric for clean and naturally glowing skin.",
    badge: "New",
    isNew: true,
    isOrganic: true,
  },

  {
    ...
    rating: 4.8,
    reviews: 112,
    image: "/images/products/Triphala-Churna.webp",
    description:
      "Traditional Triphala churna made from natural Ayurvedic ingredients for everyday digestive wellness.",
    badge: "Popular",
    isNew: false,
    isOrganic: true,
  },

  {
    ...
    rating: 4.9,
    reviews: 145,
    image: "/images/products/Amla-Hair-Oil.webp",
    description:
      "Nourishing amla hair oil enriched with bhringraj, hibiscus and brahmi to nourish the scalp and strengthen hair.",
    badge: "Top Rated",
    isNew: false,
    isOrganic: true,
  },
